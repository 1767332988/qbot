...
const notify = $.isNode() ? require('./005e3bbbdf5c49e9bada2a48a30b8f2c/sendNotify') : '';
const JXUserAgent = $.isNode() ? (process.env.JX_USER_AGENT ? process.env.JX_USER_AGENT : ``) : ``;
//Node.js用户请在jdCookie.js处填写京东ck;
const jdCookieNode = $.isNode() ? require('./005e3bbbdf5c49e9bada2a48a30b8f2c/jdCookie.js') : '';
let allMessage = '';
let allMessage2 = '';
...
function getJingBeanBalanceDetail(page) {
	return new Promise(async resolve => {
		const options = {
			...
			"body": `body=${escape(JSON.stringify({"pageSize": "200", "page": page.toString()}))}&appid=ld`,
			"headers": {
...
function jdfruitRequest(function_id, body = {}) {
	return new Promise(resolve => {
